...
export default function HomePage() {
  ...
  async function handleContactSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (action.includes("YOUR_FORM_ID")) {
      ...
      window.location.href = `mailto:simojamal15@gmail.com?subject=${subject}&body=${body}`;
      return;
    }
        ...
        <RevealOnScroll delay={3}>
          <div className="contact-layout">
            <form className="contact-form" action="https://formspree.io/f/YOUR_FORM_ID" method="POST" onSubmit={handleContactSubmit}>
              ...
              {formStatus === "error" && (
                <div className="cf-status show error">✗ Something went wrong. Try emailing simojamal15@gmail.com directly.</div>
              )}
            </form>

            <div className="contact-side">
              <a href="https://wa.me/971508762319?text=Hi%20Mohammed%2C%20I%20saw%20your%20portfolio%20and%20wanted%20to%20reach%20out." target="_blank" rel="noopener noreferrer" className="contact-card">
                ...
                <div className="contact-card-content">
                  ...
                  <div className="contact-card-value">+971 50 876 2319</div>
                </div>
                <span className="contact-card-arrow">→</span>
              </a>

              <a href="mailto:simojamal15@gmail.com" className="contact-card">
                ...
                <div className="contact-card-content">
                  ...
                  <div className="contact-card-value">simojamal15@gmail.com</div>
                </div>
                <span className="contact-card-arrow">→</span>
              </a>
              ...
              <a href="https://github.com/simojamal" target="_blank" rel="noopener noreferrer" className="contact-card">
                ...
                <div className="contact-card-content">
                  ...
                  <div className="contact-card-value">@simojamal</div>
                </div>
                <span className="contact-card-arrow">→</span>
              </a>
            </div>
